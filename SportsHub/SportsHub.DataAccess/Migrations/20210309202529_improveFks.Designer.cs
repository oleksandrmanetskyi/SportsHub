...
namespace SportsHub.DataAccess.Migrations
{
    ...
    [Migration("20210309202529_improveFks")]
    partial class improveFks
    {
            ...
            modelBuilder.Entity("SportsHub.DataAccess.Entities.Nutrition", b =>
                {
                    ...
                    b.Property<int?>("TrainingProgramId2")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("TrainingProgramId2");
            ...
            modelBuilder.Entity("SportsHub.DataAccess.Entities.Nutrition", b =>
                {
                    b.HasOne("SportsHub.DataAccess.Entities.TrainingProgram", "TrainingProgram")
                        .WithMany()
                        .HasForeignKey("TrainingProgramId2");
            ...
            modelBuilder.Entity("SportsHub.DataAccess.Entities.TrainingProgram", b =>
                {
                    ...
                    b.HasOne("SportsHub.DataAccess.Entities.User", "User")
                        .WithOne()
                        .HasForeignKey("SportsHub.DataAccess.Entities.TrainingProgram", "UserId")
                        .OnDelete(DeleteBehavior.Restrict);
